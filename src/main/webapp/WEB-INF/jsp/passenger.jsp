...
<div class="form-style-8">
  ...
  <option value="MUMBAI">MUMBAI</option>
    ...
    <input type="number" id="num_pass" name="num_pass" placeholder="Number of Passengers" required/>
    <input type="number" id="num_passdiss" name="num_passdiss" placeholder="Number of Passengers with Discount" required/>
